		...
		<Container maxWidth="md">
			<Box sx={{ my: 4 }}>
				...
				<Alert severity="warning" sx={{ mb: 3 }}>
					...
					only, not a substitute for professional medical advice. Always consult
					...
					<Grid container spacing={2}>
						<Grid item xs={4}>
							<Button
								...
								onClick={() =>
									setQuestion(
										"What treatment options would you recommend based on the patient's current condition?"
									)
								}
							>
								Treatment Options
						...
						<Grid item xs={4}>
							<Button
								...
								onClick={() =>
									setQuestion(
										"Please review the patient's current medications and suggest any necessary adjustments."
									)
								}
							>
								Medication Review
						...
						<Grid item xs={4}>
							<Button
								...
								onClick={() =>
									setQuestion(
										"What would be an appropriate follow-up plan for this patient?"
									)
								}
							>
								Follow-up Plan
